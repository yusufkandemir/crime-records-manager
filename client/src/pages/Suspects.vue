  ...
  <q-page class="flex flex-center" padding>
    ...
    >
      <div class="row q-col-gutter-md">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
          <q-input v-model="editedItem.Nationality" label="Nationality"></q-input>
        </div>
        <div class="col-xs-12">
          <q-input v-model="editedItem.FacialAppearance" label="Facial Appearance" autogrow></q-input>
        </div>
        <div class="col-xs-12">
          <q-input v-model="editedItem.PhysicalAppearance" label="Physical Appearance" autogrow></q-input>
        </div>
      </div>
    </c-serverside-crud-table>
  </q-page>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          name: 'facialAppearance',
          label: 'Facial Appearance',
          field: 'FacialAppearance',
          sortable: true,
          filterable: true
        },
        {
